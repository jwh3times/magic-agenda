...
// its MIME allow-list; and the read/delete object policies are back. So the authorization boundary is
...
export function renderStorageMetadata(buckets, policies) {
  ...
  if (policies.length === 0) {
    throw new Error(
      'storage.objects has no policies — refusing to record an open bucket as backed up.',
    )
  }
  return [
