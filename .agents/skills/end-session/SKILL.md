...
**Never delete these.** Each is either unrecoverable or the only copy:
...
- `dist/`, `*.tsbuildinfo` — build output, regenerated by `npm run build`.
...
- `supabase/.temp/`, `supabase/.branches/` — CLI scratch.
